...
<p align="center">
  ...
  <img src="https://img.shields.io/github/stars/yrahul05/terraform-aws-eks?style=for-the-badge"/>
</p>
...
```hcl
module "eks" {
  source      = "git::https://github.com/yrahul05/terraform-aws-eks.git?ref=v1.0.0"
  enabled     = true
  name        = local.name
  ...
  map_additional_iam_users = [
    {
      userarn  = "arn:aws:iam::123456789:user/yrahul05"
      username = "test"
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo                                                                                                                                                                                                                                                                    | `string` | `"https://github.com/yrahul05/terraform-aws-eks"`                                                                                                                                                                                                                                             | no |
